...
const Home = () => {
    return (
        ...
        {/* Inicio da Home */}
            <section className="grid grid-flow-col border-t border-b border-white max-w-160">
                ...
                <div className="border-white border-e">
                    <div className="grid grid-flow-row border-white border-b">
                        {/* Slogan */}
                        <div className=" grid grid-flow-row justify-center m-20">
                        <h1 className="Michroma text-7xl text-white content-center justify-self-center">SUA FUNDAÇÃO PARA O <br />
                            <span className=" text-laranja-primary">FUTURO</span>
                        </h1>
                        <br />
                        {/* Texto sobre a empresa */}
                        <div className="grid">
                        <p className="text-lg text-white content-center justify-self-center" >A A6 Construtora é uma construtora de Goiânia - GO dedicada a oferecer soluções inovadoras e de alta qualidade para uma ampla gama de projetos residenciais e industriais.</p>
                        <br />
                        </div>
                        {/* Botão Para Contato */}
                        <div className="grid">
                        <button className="flex items-center border text-white border-white rounded-full  justify-self-start text-lg text-nowrap p-5 hover:bg-laranja-primary duration-500 ">
                    ...
                    <div className="grid grid-flow-col  justify-items-center border-white border-e  me-5">
                        <div className="border border-white m-10">
                            ...
                            <div className="m-3">
                                ...
                                <a className=" cursor-pointer text-laranja-primary">Ver mais +</a>
                            </div>
                        </div>
                        <div className="border border-white m-10">
                            ...
                            <div className="m-3">
                                ...
                                <a className=" text-laranja-primary cursor-pointer ">Ver mais +</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="grid max-w-160 grid-flow-col justify-center text-center text-white border-white border mx-10">
                <div className="m-8">
