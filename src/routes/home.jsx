...
const Home = () => {
    return (
        <>
            ...
            <br />
            <section className="mx-32 grid grid-flow-row lg:grid-flow-col">
            ...
            <section className="grid relative text-center lg:text-start justify-center grid-flow-row lg:grid-cols-2 lg:border lg:border-white my-28 mx-32 gap-10 top-20 p-10">
                ...
                <div className="grid grid-flow-row gap-10">
                    ...
                    <div className="grid grid-flow-row justify-center md:grid-cols-2 justify-items-center lg:hidden gap-5">
                        <div className="grid grid-flow-col items-center">
                            <button className="rounded-full p-3 border border-white grid grid-flow-col items-center cursor-pointer">
