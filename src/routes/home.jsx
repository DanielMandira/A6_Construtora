        ...
        <>
            ...
            <section className="grid grid-flow-row md:grid-flow-col border-white md:border-b white lg:max-w-160">
                ...
                <div className="border-white md:border-e ">
                    ...
                    <div className="grid grid-flow-col justify-center gap-5 p-5 border-white lg:border-e  lg:me-5">
                        <div className="border  border-white w-32 sm:w-36 my-10 md:w-auto max-w-96">
                            <img className=" grayscale w-32 md:w-auto md:h-auto sm:w-36 h-39 lg:w-96 lg:h-40" src={Obras} />
                            <div className="m-3">
                        ...
                        <div className="border border-white w-32 sm:w-36 md:w-auto my-10 max-w-96">
                            <img className=" grayscale w-32 sm:w-36 h-38  md:w-auto md:h-auto lg:w-96 lg:h-40" src={Comercial} />
                            <div className="m-3">
            ...
            <section className="grid grid-flow-row text-center mx-10">
                ...
                <div className="grid grid-flow-row lg:grid-flow-col gap-5">
                    ...
                    <div className="grid grid-flow-row gap-5 text-center border border-white md:text-start justify-self-center p-5 lg:ms-5 max-w-847">
                        ...
                        <div className="lg:grid lg:grid-flow-col   justify-center gap-5 items-center md:flex md:flex-row-reverse md:justify-start md:justify-self-start ">
                            <h3 className="text-white text-base md:text-2xl lg:max-w-80 sora">Conheça os <span className=" text-laranja-primary">benefícios</span> de trabalhar com a equipe de especialistas da A6</h3>
                ...
                <div className="hidden md:grid grid-flow-row mx-10 my-28">
                    ...
                    <div className="lg:grid hidden grid-flow-col relative gap-x-5">
                        ...
                        <div className="absolute lg:grid  hidden bg-laranja-primary size-20 z-0 top-26 left-100"></div>
                ...
                <div className="grid grid-flow-row justify-center content-center justify-self-center  md:grid-cols-2  my-16 gap-5 lg:mt-56 md:justify-start mx-10">
                    <div className="grid grid-flo gap-10">
                        ...
                        <div className="grid grid-flow-row justify-items-center md:justify-start md:justify-items-start gap-5 p-3 md:text-start border-white border md:h-full">
                            <div className=" md:w-406 md:h-481 lg:w-640 lg:h-642 justify-self-center relative grid ">
                        ...
                        <div className="grid grid-row justify-items-center md:justify-start md:justify-items-start gap-5 p-3 md:text-start content-end border-white border h-full">
                            <div className="md:w-406 md:h-316 lg:w-640 lg:h-393 justify-self-center relative grid ">
                                <div className="absolute bottom-3 left-3 z-10 grid grid-flow-col items-center">
                                    <img className="size-14 opacity-50" src={Mouse} />
                                    <p className=" sora text-xs text-white">Passe o mouse <br /> acima da imagem</p>
                                </div>
                    ...
                    <div className="grid grid-flow-row gap-10">
                        ...
                        {/* Pojeto 4 */}
                        <div className="ggrid grid-row justify-items-center md:justify-start md:justify-items-start gap-5 p-3 md:text-start content-end border-white border md:h-full">
                        <div className=" md:w-406 md:h-481 lg:w-640 lg:h-642 justify-self-center relative grid ">
                                <div className="absolute bottom-3 left-3 z-10 grid grid-flow-col items-center">
                                    <img className="size-14 opacity-50" src={Mouse} />
                                    <p className=" sora text-xs text-white">Passe o mouse <br /> acima da imagem</p>
            ...
            <section className="mx-10 grid grid-flow-row lg:grid-flow-col">
                <div className="grid grid-flow-row justify-center">
                    ...
                    <h2 className="Michroma text-white text-2xl lg:text-7xl">SEU PROJETO, NOSSA <span className="text-laranja-primary">EXPERTISE</span></h2>
                </div>
                <div >
