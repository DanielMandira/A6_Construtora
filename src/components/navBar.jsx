...
const NavBar = () => {
    ...
    const Modal = () => {
        return (
            <header className={`${isOpen ? 'fixed top-0 start-0 grid grid-flow-row bg-grafite p-10 duration-500 w-9/12 z-10 h-full  lg:hidden xl:hidden text-start gap-0 ' : 'hidden'}`}>
