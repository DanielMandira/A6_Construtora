    ...
    return (
        <header className={`Sora grid grid-flow-col text-nowrap border-white border-b text-center text-white`}>
            ...
            <div className=" border-e border-white content-center ">
                <h1 className=' text-base mx-5 text-laranja-primary sm:base md:text-xl lg:text-3xl'><img src={A6_icon}/></h1>
            </div>
            ...
            <div className={` hidden sm:hidden md:hidden border-e lg:grid border-white content-center`}>        <Link className="hover:text-laranja-primary nav-link text-white" activeClassName="text-laranja-primary" to='#'>
                Projetos
            </Link>
            </div>
            <div className={` hidden sm:hidden md:hidden border-e lg:grid border-white content-center`}>        <Link className="hover:text-laranja-primary nav-link text-white" activeClassName="text-laranja-primary" to='#'>
